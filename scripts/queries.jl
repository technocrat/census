...
WITH age_totals AS (
    SELECT 
        CASE 
            ...
            WHEN v.variable_name IN ('male_65_and_66_years', 'male_67_to_69_years', 'female_65_and_66_years', 
'female_67_to_69_years') THEN '65 to 69 years'
